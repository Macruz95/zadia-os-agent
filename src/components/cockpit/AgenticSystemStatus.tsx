        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="flex gap-4 lg:col-span-1">
            <div className="text-center p-3 bg-muted/50 rounded-lg border border-border flex-1">
              ...
              <div className="text-xl font-bold text-foreground">{stats.activeAgents}</div>
            ...
            <div className="text-center p-3 bg-muted/50 rounded-lg border border-border flex-1">
              ...
              <div className="text-xl font-bold text-foreground">{stats.propagationRules}</div>
          ...
          <div className="lg:col-span-3">
            <Tabs defaultValue="agents" className="w-full">
              <TabsList className="grid w-full grid-cols-2 h-8 bg-muted/50 border border-border">
                <TabsTrigger value="agents" className="text-xs data-[state=active]:bg-background data-[state=active]:text-foreground">
                  <Bot className="h-3 w-3 mr-1" />
                  Agentes
                </TabsTrigger>
                <TabsTrigger value="rules" className="text-xs data-[state=active]:bg-background data-[state=active]:text-foreground">
              ...
              <TabsContent value="agents" className="mt-2">
                <StaggerList className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2">
                  {agents.map(agent => (
                    <div
                      key={agent.id}
                      className="flex items-center justify-between p-2 rounded-lg bg-muted/50 border border-border hover:border-border/80 transition-colors"
                    >
              ...
              <TabsContent value="rules" className="mt-2">
                <StaggerList className="grid grid-cols-2 md:grid-cols-3 gap-2">
