          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50 border border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-foreground font-medium text-sm">Sonidos</p>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50 border border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-foreground font-medium text-sm">Escritorio</p>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50 border border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-foreground font-medium text-sm">Horas silenciosas</p>
          ...
          <div className="p-4 rounded-lg bg-muted/50 border border-border">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-foreground font-medium">Resumen por Email</p>
              ...
              >
                <SelectTrigger className="w-40 bg-gray-800 border-border">
                  <SelectValue />
                </SelectTrigger>
      ...
      <Card className="bg-gray-800/30 border-border">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-foreground">Categorías de Notificaciones</CardTitle>
        ...
        <CardContent>
          ...
          <div className="space-y-2">
            {categories.map((category) => (
              <div 
                key={category.id}
                className="grid grid-cols-[1fr,80px,80px,80px] gap-4 items-center p-4 rounded-lg bg-muted/50 border border-border hover:border-border/80 transition-colors"
              >
                <div className="flex items-center gap-3">
      ...
      <Card className="bg-gray-800/30 border-border">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-foreground">Notificaciones Push</CardTitle>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50 border border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-foreground font-medium">Este navegador</p>
